...
public class CaixaEletronico {
	...
	/**
	 * realiza uma varredura nas notas do caixa e retorna a lista de notas dispon�veis
	 * 
	 * @return
	 */
	...
	/**
	 * algoritimo que realiza um mapeamento(uma carga) das notas no caixa eletr�nico para demais opera��es
	 *  
	 * @param valor
	 */
	...
	/**
	 * Auxilia m�todo sacar, removendo as notas do caixa ap�s realizar
	 * a verifica��o com m�todo <code>verificarNotas()</code>
	 * @param valorSacar
	 */
	...
	/**
	 * Algoritmo que verica se h� notas dispon�veis no caixa eletr�nico recebendo um valor a ser removido
	 * como par�metro.
	 * Auxilia m�todo sacar. 
	 * @param valor
	 * @return
	 */
	 ...
	 * atrav�s do ENUM <class>ValorNota</class>
	 */
